...
export const Cart = () => {
  ...
  useEffect(() => {
    ...
    cartItem.forEach((item) => {
      temp += parseInt(item?.price, 10) || 0;
    });
    setTotalAmount(temp);
  }, [cartItem]);

  const shipping = totalAmount === 0 ? 0 : 100;
  ...
  const buyNow = async () => {
    ...
    const options = {
      key: "rzp_test_hJhqXT686QFJio",
      key_secret: "vgi6Bqi8HGTJcynLWzz1YONP",
    ...
    <Layout>
      ...
      >
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          <div className="rounded-lg h-[70vh] md:w-2/3 overflow-scroll overflow-x-hidden ">
            {cartItem != 0 ? (
